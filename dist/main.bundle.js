...
var inputAjout = document.querySelector('form > input');
var todosList = [{
...
var displayTodo = function displayTodo() {
  var todoNode = todosList.map(function (todo, index) {
    console.log('ici');
...
var createTodoElem = function createTodoElem(todo, index) {
  ...
  li.innerHTML = "\n        <span class=\"todo ".concat(todo.done ? 'done' : '', "\"></span>\n        <p class=\"").concat(todo.done ? 'text-barre' : '', "\">").concat(todo.text, "</p>\n    ");
...
var setDone = function setDone(index, li) {
...
var editTodo = function editTodo(index, input) {
  if (input.value) {
    var text = firstLetterToUpperCase(input.value);
...
var firstLetterToUpperCase = function firstLetterToUpperCase(text) {
  var value = Array.from(text);
